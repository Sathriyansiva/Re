...
public class Marutiadpt extends BaseAdapter {

    private Context mContext;
   List<AppmodelList> Modelist;
    private LayoutInflater layoutInflator;
    public Marutiadpt(Context context,List<AppmodelList> Modelist) {
        //mContext = c;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            grid_text.setText(Modelist.get(position).getModel());
            ...
            final String imageUri = "http://lucastvs-catalog.in/Admin/Uploads/App_search/"+Modelist.get(position).getImage();
